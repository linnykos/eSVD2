...
public:
    ObjectiveX(MapMat Y, SEXP B, SEXP Zi, MapVec Ai, Environment family, double si, MapVec gamma, double offseti) :
    ...
    double objfn(NumericVector x)
    {
        ...
        return objfn_Xi_impl(Xi, m_Y, m_B, m_Zi, m_Ai, m_family, m_si, m_gamma, m_offseti);
    }

    NumericVector grad(NumericVector x)
    {
        MapVec Xi = Rcpp::as<MapVec>(x);
        return grad_Xi_impl(Xi, m_Y, m_B, m_Zi, m_Ai, m_family, m_si, m_gamma, m_offseti);
    }

    NumericMatrix hessian(NumericVector x)
    {
        MapVec Xi = Rcpp::as<MapVec>(x);
        return hessian_Xi_impl(Xi, m_Y, m_B, m_Zi, m_Ai, m_family, m_si, m_gamma, m_offseti);
    }

    List direction(NumericVector x)
    {
        MapVec Xi = Rcpp::as<MapVec>(x);
        return direction_Xi_impl(Xi, m_Y, m_B, m_Zi, m_Ai, m_family, m_si, m_gamma, m_offseti);
    }
...
public:
    ObjectiveY(MapMat X, MapVec Aj, Environment family, MapVec s, double gammaj, MapVec offset) :
    ...
    double objfn(NumericVector y)
    {
        ...
        return objfn_Yj_impl(Yj, m_X, R_NilValue, R_NilValue, m_Aj, m_family, m_s, m_gammaj, m_offset);
    }

    NumericVector grad(NumericVector y)
    {
        MapVec Yj = Rcpp::as<MapVec>(y);
        return grad_Yj_impl(Yj, m_X, R_NilValue, R_NilValue, m_Aj, m_family, m_s, m_gammaj, m_offset);
    }

    NumericMatrix hessian(NumericVector y)
    {
        MapVec Yj = Rcpp::as<MapVec>(y);
        return hessian_Yj_impl(Yj, m_X, R_NilValue, R_NilValue, m_Aj, m_family, m_s, m_gammaj, m_offset);
    }

    List direction(NumericVector y)
    {
        MapVec Yj = Rcpp::as<MapVec>(y);
        return direction_Yj_impl(Yj, m_X, R_NilValue, R_NilValue, m_Aj, m_family, m_s, m_gammaj, m_offset);
    }
