...
```
With this done, we can save this minimal Seurat object for the eSVD-DE vignette. This file will be roughly 302 Mb in size.
...
knitr::include_graphics("../vignettes/asd-umap.png")
```
